...
urlpatterns = [
    ...
    path('api/firma-estado/<uuid:token>/', views.estado_firma, name='estado_firma_old'),
    path('api/firma-estado/<uuid:token>/<str:firmante_token>/', views.estado_firma, name='estado_firma'),
    ...
    path('api/firmx/config/save/', views.firmx_guardar_config, name='firmx_guardar_config'),
