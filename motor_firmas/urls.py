...
urlpatterns = [
    ...
    # RUTAS DE PLANTILLAS (Cambiado a <str:> por los IDs de MongoDB)
    ...
    # FIX: Cambiado de <int:pdf_id> a <str:pdf_id>
    path('api/eliminar-pdf-usuario/<str:pdf_id>/', views.eliminar_pdf_usuario, name='eliminar_pdf_usuario'),
    path('portal/configurar-pdf/<str:pdf_id>/', views.portal_configurar_pdf, name='portal_configurar_pdf'),
    ...
    # FIX: Cambiado de <int:plantilla_id> a <str:plantilla_id>
